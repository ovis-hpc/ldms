...
# June 17, 2015
#
# This file has been modified to be compatible with the OVIS project.
#
# READLINE_LIBS and READLINE_CFLAGS are also created.
#
# If libreadline is available,
#    	READLINE_LIBS=-lreadline
#
#    	READLINE_CFLAGS=-DHAVE_LIBREADLINE or
...
AC_DEFUN([AX_LIB_READLINE], [
  ...
  if test "x$disable_readline" != "xyes"; then
