...
#define CURRENT_SLOT_MID(s)	3
#define JOB_STATE_MID(s)	4
#define JOB_SIZE_MID(s)		5
#define JOB_UID_MID(s)		6
#define JOB_GID_MID(s)		7
#define JOB_START_MID(s)	8
#define JOB_END_MID(s)		9
#define NODE_COUNT_MID(s)	10
#define TASK_COUNT_MID(s)	11
#define TASK_PID_MID(s)		12
