Name:           libevent2
Version:        2.1.3
Release:        alpha.ovis1%{?dist}
Summary:        Abstract asynchronous event notification library

Group:          System Environment/Libraries
License:        BSD
URL:            http://sourceforge.net/projects/levent/
Source0:        http://downloads.sourceforge.net/levent/libevent-%{version}-alpha.tar.gz
...
%prep
%setup -q -n libevent-%{version}-alpha
...
(cd sample; \
  install -p -m 644 *.c $RPM_BUILD_ROOT/%{_docdir}/%{name}-devel-%{version}/sample)
...
- Made 2.1.3-alpha relocatable and default to /opt/ovis.
