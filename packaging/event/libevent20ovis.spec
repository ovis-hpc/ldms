...
sed -i -e s%/opt/ovis%$RPM_INSTALL_PREFIX%g $RPM_INSTALL_PREFIX/lib64/pkgconfig/libevent.pc
sed -i -e s%/opt/ovis%$RPM_INSTALL_PREFIX%g $RPM_INSTALL_PREFIX/lib64/pkgconfig/libevent_openssl.pc
sed -i -e s%/opt/ovis%$RPM_INSTALL_PREFIX%g $RPM_INSTALL_PREFIX/lib64/pkgconfig/libevent_pthreads.pc
...
%changelog
* Fri Oct 04 2013 Benjamin Allan <baallan@sandia.gov> 2.1.3-alpha.ovis1
...
* Fri Oct 04 2013 Benjamin Allan <baallan@sandia.gov> 2.0.21-3.ovis1
- Made 2.0.21-3 relocatable and default to /opt/ovis.
- Cannot cohabit in /usr with 1.4 in centos6.
